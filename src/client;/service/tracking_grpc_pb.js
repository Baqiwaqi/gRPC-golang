...
function serialize_flightTracking_MyService_Flight_NoParams(arg) {
  if (!(arg instanceof service_tracking_pb.MyService.Flight.NoParams)) {
    throw new Error('Expected argument of type flightTracking.MyService.Flight.NoParams');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_flightTracking_MyService_Flight_NoParams(buffer_arg) {
  return service_tracking_pb.MyService.Flight.NoParams.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var FlightTrackingService = exports.FlightTrackingService = {
  ...
  listFlights: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: service_tracking_pb.MyService.Flight.NoParams,
    responseType: service_tracking_pb.MyService.Flight.Response,
    requestSerialize: serialize_flightTracking_MyService_Flight_NoParams,
    requestDeserialize: deserialize_flightTracking_MyService_Flight_NoParams,
    responseSerialize: serialize_flightTracking_MyService_Flight_Response,
    responseDeserialize: deserialize_flightTracking_MyService_Flight_Response,
  },
};
